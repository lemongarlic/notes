...
function _G.Notes.setup (config)
  config = config or {}
  state.init(config)
  database.init()
  note.init()
...
function _G.Notes.api.open ()
  prompt.open()
end

function _G.Notes.api.notes ()
  database.find_note()
end

function _G.Notes.api.toggle ()
...
function _G.Notes.api.delete ()
  local current_file = vim.fn.expand'%:p'
  database.delete_note(current_file)
end

function _G.Notes.api.undo ()
...
function _G.Notes.api.bookmarks.add (number)
  database.insert_bookmark(number)
end

function _G.Notes.api.bookmarks.remove (number)
  database.remove_bookmark(number)
end

function _G.Notes.api.bookmarks.go (number)
  database.goto_bookmark(number)
end

function _G.Notes.api.bookmarks.list ()
